...
const MessageContainer = () => {
  ...
  const checkIfImage = (filePath) => {
    const imageRegex =
      /\.(jpg|jpeg|png|svg|webp|gif|bmp|tiff|tif|ico|heic|heif)$/i;
  ...
  const downloadFile = async (url) => {
    ...
    const response = await apiClient.get(`http://localhost:6969/${url}`, {
      responseType: "blob",
        ...
        {message.messageType === "file" && (
          ...
          >
            {checkIfImage(message.fileUrl) ? (
              ...
              >
                <img
                  src={`http://localhost:6969/${message.fileUrl}`}
                  alt="Media"
                  height={300}
                  width={300}
                />
          ...
          <div className="flex items-center justify-start gap-3">
            ...
            <Avatar className="h-8 w-8 rounded-full overflow-hidden ">
              {message.sender.image && (
                <AvatarImage
                  src={`http://localhost:6969/${message.sender.image}`}
                  alt="Profile"
